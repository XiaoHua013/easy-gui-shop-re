...
public class PlayerInputAfterClickManageGoodPageGoodOptionPageSetGoodLimitFrequency extends FiniteInputListenerBase {

    private final ManageGoodPageGoodOptionPage manageGoodPageGoodOptionPage;

    public PlayerInputAfterClickManageGoodPageGoodOptionPageSetGoodLimitFrequency(Player player, OfflinePlayer owner, ManageGoodPageGoodOptionPage manageGoodPageGoodOptionPage) {
        super(player, owner, manageGoodPageGoodOptionPage, 1);
        this.manageGoodPageGoodOptionPage = manageGoodPageGoodOptionPage;
        MessageUtil.sendMessageTo(player, MessageYaml.INSTANCE.getStringList("message.chat.howToSetGoodLimitFrequency"));
    }
    ...
    public void run() {
        ...
        try {
            guiService.setGoodLimitFrequency(manageGoodPageGoodOptionPage.getGoodMeta().getUuid(), price);
        ...
        MessageUtil.sendMessageTo(player, MessageYaml.INSTANCE.getStringList("message.chat.setGoodLimitFrequency"));
    }
}
