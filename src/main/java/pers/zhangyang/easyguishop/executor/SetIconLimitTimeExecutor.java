...
public class SetIconLimitTimeExecutor extends ExecutorBase {

    public SetIconLimitTimeExecutor(@NotNull CommandSender sender, String cmdName, @NotNull String[] args) {
    ...
    protected void run() {
        ...
        try {
            guiService.setIconLimitTime(args[0], price);
        ...
        MessageUtil.sendMessageTo(sender, MessageYaml.INSTANCE.getStringList("message.chat.setIconLimitTime"));
    }
}
